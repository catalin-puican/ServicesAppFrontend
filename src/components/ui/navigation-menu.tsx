  ...
  return (
    <div
      className={cn(
        ...
        "group-data-[align=end]/navigation-menu:left-auto group-data-[align=end]/navigation-menu:right-0 group-data-[align=end]/navigation-menu:justify-end",
        className
      )}
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          "group-data-[align=end]/navigation-menu:origin-top-right",
          className
        )}
        {...props}
      />
